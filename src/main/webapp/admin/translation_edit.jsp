...
<head>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('select#module').chosen({disable_search_threshold: 10, allow_single_deselect: true});
          ...
          <thead>
	          <tr class="header">
	              <td align="right" colspan="5">
	                  ...
	                  <b>Key</b> <input type="text" id="filter" name="filter" value="${filter}" size="35"/>
	                  <input id="submitForm" type="submit" value="Filter" class="searchButton"/>
	              </td>
	          </tr>
	          <tr>
