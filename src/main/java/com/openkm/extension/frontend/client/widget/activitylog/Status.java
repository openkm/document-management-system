...
public class Status extends PopupPanel {
	...
	private boolean flag_getActivityLog = false;
	 ...
	 */
	public void refresh() {
		if (flag_getActivityLog) {
			Widget tab = ActivityLog.get().getWidgetTab();
	...
	/**
	 * Sets the get activity log flag
	 */
	public void setGetActivityLog() {
		msg.setHTML(GeneralComunicator.i18nExtension("activitylog.tab.get.log"));
		flag_getActivityLog = true;
		refresh();
	}

	/**
	 * Unset the get activity log flag
	 */
	public void unsetGetActivityLog() {
		flag_getActivityLog = false;
		refresh();
	}
}