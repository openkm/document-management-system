...
public class Menu extends Composite {
	...
	Command deletePropose = new Command() {
		public void execute() {
			if (deleteOption) {
				MessagingToolBarBox.get().confirmPopup.setConfirm(ConfirmPopup.CONFIRM_DELETE_PROPOSED_SUBSCRIPTION_RECEIVED_FROM_USER);
	 ...
	 */
	public void hide() {
		MessagingToolBarBox.get().messageDashboard.messageStack.proposedSubscriptionReceived.menuPopup.hide();
	}
}