...
public class ExtendedFlexTable extends FlexTable {
	...
	public void setSelectedPanel(boolean selected) {
		...
		if (selected) {
			MessagingToolBarBox.get().messageDashboard.messageStack.scrollProposeQueryReceivedPanel.addStyleName("okm-PanelSelected");
		} else {
			MessagingToolBarBox.get().messageDashboard.messageStack.scrollProposeQueryReceivedPanel.removeStyleName("okm-PanelSelected");
		}
