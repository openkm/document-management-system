...
public class ExtendedFlexTable extends FlexTable {
	...
	public void setSelectedPanel(boolean selected) {
		...
		if (selected) {
			MessagingToolBarBox.get().messageDashboard.messageStack.scrollProposeSubscriptionReceivedPanel.addStyleName("okm-PanelSelected");
		} else {
			MessagingToolBarBox.get().messageDashboard.messageStack.scrollProposeSubscriptionReceivedPanel.removeStyleName("okm-PanelSelected");
		}
