	        ...
	        <thead>
		          ...
		          <td align="right" colspan="9">
		            <form action="Auth">
		              ...
		              <b>Name</b> <input type="text" name="nameFilter" value="${nameFilter}" size="20" id="nameFilter"/>
		              <b>Id</b> <input type="text" name="idFilter" value="${idFilter}" size="20" id="idFilter"/>
